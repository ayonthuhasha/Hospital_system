...
public class dateController {
    ...
    public dateController(String dateString){
    ...
    public dateController(int day, int month, int year) {
        this.day = day;
        this.month = month;
        this.year = year;
    }
    ...
    public dateController(){//default constructor set the current date for object
